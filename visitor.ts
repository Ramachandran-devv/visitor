...
// on which they operate. This pattern involves a visitor class that changes the executing algorithm of an element class. 
// By doing this, the execution algorithm of an element can change as the visitor varies. 
// This pattern comes in handy when adding new operations to existing class hierarchies without altering those structures.
